...
function FilteredPendingLegalVerificationRequest () {
    ...
    function approveLoanRequest() {
        ...
        fetch("http://localhost:8897/legal-verification/approveloan=" + id +"/agentid="+ agentid +"/", {
            method: "PATCH",
    ...
    function rejectLoan(rejectionRemarks) {
        ...
        fetch("http://localhost:8897/legal-verification/rejectloanid=" + loanId + "/remarks=" + remarks + "/agentid="+ agentid +"/", {
            method: "PATCH",
            headers: { 'Content-Type': 'application/json' },
