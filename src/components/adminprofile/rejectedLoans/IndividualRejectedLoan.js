    ...
    function rejectLoan(rejectionRemarks) {
        ...
        fetch(URI+"/admin/reject-loan/id=" + loanId + "/remarks=" + remarks + "/", {
            ...
            function response() {
                ...
                history.replace("/loans/rejected/")
            }
            ...
            {!isRejectingLoan && <div>
                ...
                <div className="btn-toolbar text-center justify-content-center" role="toolbar">
                    <div className="btn-group me-2 mb-2" role="group">
                        <button className="btn btn-dark"><Link className="text-decoration-none text-white" to="/loans/rejected/"><ImArrowLeft2 /> Back</Link></button> &nbsp;
                    </div>
                    <div className="btn-group me-2 mb-2" role="group">
            ...
            {isRejectingLoan && <div>
                <form className="form-group col-lg-4 col-md-7 mt-4 mx-auto px-3 py-3 bg-light" onSubmit={handleSubmit(rejectLoan)}>
                    ...
                    <div className="float-end">
                        ...
                        <div className="btn-group me-2 mb-2" role="group">
                            <button type="submit" className="btn btn-danger">Reject Loan <MdDone/></button>
                        </div>
                    </div>
                </form>
            </div>}
...
export default IndividualRejectedLoan;