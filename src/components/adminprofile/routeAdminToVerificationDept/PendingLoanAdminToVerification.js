...
function PendingLoanAdminToVerification() {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:8897/pending-verification/')
            .then(response => {
                                ...
                                <div className="btn-toolbar" role="toolbar">
                                    <div className="btn-group me-2 mb-2" role="group">
                                        <button className="btn btn-info" onClick={() => filterLoan(user.loanId)}>
                                            <Link className="text-decoration-none text-dark" to={`/pending-verification/${user.loanId}`}><BsCardList /> Details</Link>
                                        </button>
                                    </div>
                                </div>
                            </div>
...
export default PendingLoanAdminToVerification;