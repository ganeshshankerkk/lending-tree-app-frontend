...
function AvailableVerificationDeptAgents() {
        ...
        fetch('http://localhost:8897/verification-agents/')
            ...
            .then(getAgent => {
                ...
                if (loanRecords.length === 0) {
                    setVerificationAgent(false)
                } else if (loanRecords.length > 0) {
                    setVerificationAgent(true);
                }
    ...
    function personVerificationAgent(agentId) {
        ...
        fetch("http://localhost:8897/assign-verification/loanid=" + loanId + "/agentid=" + agentId + "/", {
            ...
            function response() {
                dispatch(loadingActions.dataLoaded());
                window.alert("Assigned to verification agent for person verification")
                            ...
                            <div className="card-body" style={{ backgroundColor: bgColor[backgroundColor] }} key={backgroundColor}>
                                ...
                                <div className="btn-toolbar" role="toolbar">
                                    <div className="btn-group me-2 mb-2" role="group">
                                        <button className="btn rounded-pill btn-primary position-relative"  onClick={() => personVerificationAgent(agent.id)} >Assign &nbsp;
...
export default AvailableVerificationDeptAgents;