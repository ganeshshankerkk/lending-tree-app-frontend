    ...
    function approveLoanRequest() {
        ...
        fetch(URI+"/pickup/approveloan=" + id +"/agentid="+ agentid +"/", {
            ...
            function response() {
                ...
                history.replace("/pickup/pending")
            }
            ...
            {!isRejectingLoan && <div>
                ...
                <div className="btn-toolbar text-center justify-content-center" role="toolbar">
                    <div className="btn-group me-2 mb-2" role="group">
                        <button className="btn btn-dark"><Link className="text-decoration-none text-white" to="/pickup/pending"><ImArrowLeft2 /> Go Back</Link></button> &nbsp;
                    </div>
                    <div className="btn-group me-2 mb-2" role="group">
...
export default FilteredPickUpRequest;