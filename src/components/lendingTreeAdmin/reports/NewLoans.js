...
function NewLoans(){
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:8897/reports-new-loans/')
            .then(response => {
                                ...
                                <div className="btn-toolbar" role="toolbar">
                                    <div className="btn-group me-2 mb-2" role="group">
                                        <button className="btn btn-info" >
                                            <Link className="text-decoration-none text-dark" onClick={() => filterLoanReports(loan.loanId)} to={`/reports/new-loans/${loan.loanId}`}><BsCardList /> Details</Link>
                                        </button>
                                    </div>
                                </div>
                            </div>
