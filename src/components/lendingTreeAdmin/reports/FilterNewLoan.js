            ...
            <div>
                ...
                <div className="btn-toolbar text-center justify-content-center" role="toolbar">
                    <div className="btn-group me-2 mb-2" role="group">
                        <button className="noprint btn btn-dark"><Link className="text-decoration-none text-white" to="/reports/new-loans/"><ImArrowLeft2 /> Back</Link></button> &nbsp;
                    </div>
